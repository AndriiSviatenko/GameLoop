...
| Demo | `Assets/Demo/Scenes/DemoScene` — press Play; keys: Space, 1, 2, C, S, R |
...
├── Editor/             GameLoop Debugger window
└── Samples~/           ManualBootstrap, VContainer, Zenject

Assets/Demo/
├── Scenes/             DemoScene
└── Scripts/
    ├── Bootstrap/      composition root, config, scene builder, focus handler
    ├── Balls/          spawner, factory, registry, ball element, collisions
    ├── Round/          round timer, score
